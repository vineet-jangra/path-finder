const verticalMaze = (grid, rowStart, rowEnd, colStart, colEnd, orientation, surroundingWalls) => {
    const animate = [];
...
const generateMaze = (grid, rowStart, rowEnd, colStart, colEnd, orientation, surroundingWalls, animate) => {
    ...
    if(orientation === 'horizontal') {
        ...
        if(rowEnd - rowStart > currentCol - 2 - colStart) {
            generateMaze(grid, rowStart, rowEnd, colStart, currentCol - 2, "vertical", surroundingWalls, animate);
        } else {
