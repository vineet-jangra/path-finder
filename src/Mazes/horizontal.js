const horizontalMaze = (grid, rowStart, rowEnd, colStart, colEnd, orientation, surroundingWalls) => {
    const animate = [];
...
const generateMaze = (grid, rowStart, rowEnd, colStart, colEnd, orientation, surroundingWalls, animate) => {
    ...
    if(orientation === 'horizontal') {
        ...
        if(currentRow - 2 - rowStart > colEnd - colStart) {
            ...
            generateMaze(grid, rowStart, currentRow - 2, colStart, colEnd, 'horizontal', surroundingWalls, animate);
        }
